package com.sanbeaman.shell.widget.activity
{
	...
	public class ACTUI_MatchBtn extends MovieClip
	{
		...
		public function ACTUI_MatchBtn()
		{
			super();
			_enabled = false;
			_isChecked = false;
		...
		public function buildBtn(btype:String,blabel:String,bwidth:Number,bheight:Number,bfilltype:String, bcolorcode:uint,uiParams:UIparams = null,fontFamily:String = "Arial",localeID:String = null):void
		{
