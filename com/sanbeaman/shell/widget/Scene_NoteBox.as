package com.sanbeaman.shell.widget
{
	...
	public class Scene_NoteBox extends BodyUI
	{
		...
		public function Scene_NoteBox()
		{
			super();
		}
		
		public function init(str:String, fontsize:Number = 14, fontcolor:String = "white", boxwidth:Number = 600,boxheight:Number = 34):void
		{
		//	this.id = id;
			//this.order = order;
			//this.time = time;
			this.type = "scenenotebox";
