/*******************************************************************************
 ...
 02/13/2013 - DrewBe: added an AlreadyUNloaded boolean and  SABA COmple&Exit Function
*******************************************************************************/
...
/*_____________________________________________
 Complete and Exit Course SABA
 Returns true if successful, false if failed.
----------------------------------------------------------------*/
function LMSCompleteAndExit() {
    var result = false;
    if (ScormIsInitialized) {
...
{
	if (name == "cmi.exit") { value = "suspend"; }
	if (value == "null")
